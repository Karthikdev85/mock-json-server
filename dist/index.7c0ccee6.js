...
function updateUser(id) {
    ...
    const user2 = usersListArray.find((user)=>user.id == id);
    // console.log(user);
    updateName.value = user2.name;
    updateUsername.value = user2.username;
    updateEmail.value = user2.email;
